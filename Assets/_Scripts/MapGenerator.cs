...
public class MapGenerator : MonoBehaviour
{
    ...
    public void SaveMap()
    {
        ...
        AssetDatabase.CreateAsset(map, "Assets/Prefabs/ScriptableObjects/Maps/NewMap_" + mapSize.x + "x" + mapSize.y + ".asset");
    ...
    public void Setup()
    {
        ...
        for (int i = 0; i < mapSize.x; i++)
            for (int j = 0; j < mapSize.y; j++)
            {
                ...
                s.Setup(new Vector2Int(i, j), squaresList[z].SquareType, squaresList[z].Team);
                z++;
            }
    }
}
